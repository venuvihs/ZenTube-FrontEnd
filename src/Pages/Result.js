        ...
        <div className=" bg-bg-result relative w-full min-h-screen">
            ...
            <div className="w-11/12 mx-auto relative z-30">
                ...
                <div className="grid grid-cols-3 gap-2">
                    <div className=" rounded-xl bg-red-500 col-span-2 row-span-2 col-start-1 px-4 py-2">
                        ...
                        <div className=" w-full grid grid-cols-4 gap-3">
                            <div className="bg-gray-200 col-span-2 row-span-2 col-start-1">.</div>
                            <div className="bg-gray-200 col-span-1 row-span-1 col-start-3">.</div>
                            <div className="bg-gray-200 col-span-1 row-span-1 col-start-4">.</div>
                            <div className="bg-gray-200 col-span-2 row-start-2 col-start-3">.</div>
                        </div>
                    </div>
                    <div className=" rounded-xl bg-blue-500 col-span-1 row-span-1 col-start-3 px-2 py-1">
                        <p className="font-semibold text-lg tracking-wide text-white">Upload</p>
                        <input type="file" name="" id="uploadMP3" className="hidden" onChange={(e) => handeChange(e)} />
                        <div className="w-full border border-dashed border-white grid place-content-center py-4" htmlFor="uploadMP3">
                            ...
                            <label htmlFor="uploadMP3" className="text-white text-lg cursor-pointer"><span className="underline">Upload</span>  your mp3/mp4</label>
                    ...
                    <div className=" rounded-xl bg-red-500 col-span-1 row-span-1 col-start-3 row-start-2">.</div>
                </div>
                ...
                <div className=" flex flex-col w-full py-8 px-10 rounded-3xl bg-gray-800 justify-items-start mt-10">
                    ...
                    <textarea name="" id="" cols="30" rows="5" value={text} className="w-full mt-3"></textarea>
                    ...
                    <div className="grid grid-cols-4 mt-16 space-x-8">
                        <div className=" col-span-2 flex flex-col flex-2">
                            ...
                            <p className="text-yellow-300">Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio illum id nobis esse magni officiis natus, soluta dignissimos possimus exercitationem magnam, odio odit corporis pariatur eveniet ducimus assumenda non quia facere obcaecati iure maiores. Ipsum animi dolore provident quis exercitationem in, sunt alias quas, recusandae harum explicabo obcaecati ratione! Facilis repudiandae amet et, omnis eaque laboriosam repellendus eos natus commodi.</p>
                        </div>
                        ...
                        <div className="KEYPOINTS col-span-1 flex-1 flex flex-col justify-center items-center  py-2 bg-blue-300 rounded-3xl">
                            ...
                            <p className="py-1 border-b border-blue-400 mb-2">Passing props - <span>10:34</span></p>
                            <p className="py-1 border-b border-blue-400 mb-2">Passing props - <span>10:34</span></p>
                            <p className="py-1 border-b border-blue-400 mb-2">Passing props - <span>10:34</span></p>
                        </div>
                        <Positive />
                ...
                <h1 className="text-3xl text-white font-bold tracking-wider mt-12">Previous Searches</h1>
